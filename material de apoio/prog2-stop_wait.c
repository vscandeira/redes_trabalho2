...
A_output(message)
	 ...
	 * pseudo header: composto por ip de destino e origem, tamanho do segmento TCP, protocolo, fixed of 8-bits
	 * 		como ips e protocolo fogem ao escopo deste trabalho, e considerando que tamanho do segmento será fixo, pseudoheader será desconsiderado do checksum
	 * tcp header
	 * 		para os propósitos desse trabalho, será utilizado o "cabeçalho" previamente definido da struct pkt
	 * tcp payload
	 */
