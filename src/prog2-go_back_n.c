...
int baseA;
int seqB;
struct msg curr_msgs[WINDOWSIZE];				//array de mensagens da janela de A que precisas serem guardadas no caso de NACK, ACK corrompido ou timeout
A_output(message)
	struct msg message; {
